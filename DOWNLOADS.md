...
**Latest public release:** `v4.2-mobile`  
**Campus in repo:** `v4-PORTFOLIO.html` · **431 lessons** · ~3.6 MB HTML  
...
Built-in **export center** can save study packs as HTML / PDF / Markdown / JSON / CSV from the campus UI (no install).
...
- First open may take a few seconds (full **431-lesson** campus)
